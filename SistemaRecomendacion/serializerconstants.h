...
const std::string SerializerConstants::SLOPONE = std::string("serializer/slopone/");
...
const std::string SerializerConstants::MOVIELEANS_27M=std::string("serializer/movieleans_27m/");//movieleans_27m_unorderMap  
...
const std::string SerializerConstants::MOVIERATINGS = std::string("serializer/movie_ratings/");
